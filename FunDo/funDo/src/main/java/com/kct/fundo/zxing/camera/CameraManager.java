...
package com.kct.fundo.zxing.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = Utils.dip2px(BTNotificationApplication.getInstance(), 240);
	private static final int MIN_FRAME_HEIGHT = Utils.dip2px(BTNotificationApplication.getInstance(), 240);
	private static final int MAX_FRAME_WIDTH = Utils.dip2px(BTNotificationApplication.getInstance(), 240);
	private static final int MAX_FRAME_HEIGHT = Utils.dip2px(BTNotificationApplication.getInstance(), 240);
