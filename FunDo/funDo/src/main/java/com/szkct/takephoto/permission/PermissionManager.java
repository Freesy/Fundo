...
public class PermissionManager {
    ...
    public static void handlePermissionsResult(Activity activity, TPermissionType type, InvokeParam invokeParam,
        ...
        switch (type) {
            case DENIED:
                listener.takeFail(null, tip = activity.getResources().getString(com.kct.fundo.btnotification.R.string.tip_permission_camera_storage));
                break;
            case ONLY_CAMERA_DENIED:
                listener.takeFail(null, tip = activity.getResources().getString(com.kct.fundo.btnotification.R.string.tip_permission_camera));
                break;
            case ONLY_STORAGE_DENIED:
                listener.takeFail(null, tip = activity.getResources().getString(com.kct.fundo.btnotification.R.string.tip_permission_storage));
                break;
            case GRANTED:
                try {
