...
public class TemperatureDao extends AbstractDao<Temperature, Long> {
    ...
    public static final String TABLENAME = "Temperature_test";    // 睡眠表
    /**
    ...
    */
    public static class Properties {
        ...
        public final static Property TemperatureValue = new Property(4, String.class, "temperaturevalue", false, "temperaturevalue");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Temperature_test' (" + //
                "'_id' INTEGER PRIMARY KEY ," + // 0: id
                "'Mac' TEXT," + // 1: HeightBlood
                "'Date' TEXT," + // 2: MinBlood
                "'BinTime' TEXT," + // 3: Hour
                "'TemperatureValue' TEXT );" // 5: Conunt
                ); // 12
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'Temperature_test'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Temperature entity) {
        stmt.clearBindings();
        ...
        stmt.bindString(5, entity.getTemperatureValue());
    }
    ...
    public void readEntity(Cursor cursor, Temperature entity, int offset) {
        ...
        entity.setTemperatureValue(cursor.getString(offset + 4));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Temperature entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
