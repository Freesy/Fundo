...
public class HealthReportContantsDataRun {
	...
	public static final double BMI_WEIGHT = 35.0;
	public static final int HEART_RATE_WEIGHT = 15;
	public static final int VITAL_CAPACITY_WEIGHT = 30;

	public static final double MALE_BMI_BASE_VALUE_1 = 20.9;
	public static final double MALE_BMI_BASE_VALUE_2 = 21.6;
	public static final double MALE_BMI_BASE_VALUE_3 = 22.0;
	public static final double MALE_BMI_BASE_VALUE_4 = 22.3;
	public static final double MALE_BMI_BASE_VALUE_5 = 21.9;
	...
	public static final double FEMALE_BMI_BASE_VALUE_1 = 19.7;
	public static final double FEMALE_BMI_BASE_VALUE_2 = 20.5;
	public static final double FEMALE_BMI_BASE_VALUE_3 = 21.8;
	public static final double FEMALE_BMI_BASE_VALUE_4 = 22.4;
	public static final double FEMALE_BMI_BASE_VALUE_5 = 22.2;
	...
	public static final double ONE_STEP_DISTANCE = 0.65; // 单位 m
