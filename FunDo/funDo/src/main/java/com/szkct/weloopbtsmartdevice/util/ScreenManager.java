...
import com.szkct.weloopbtsmartdevice.activity.SinglePixelActivity;
...
public class ScreenManager {   // todo --- 启动和关闭保活
    private static final String TAG = "KeepAppAlive";   // KeepAppAlive    ScreenManager
