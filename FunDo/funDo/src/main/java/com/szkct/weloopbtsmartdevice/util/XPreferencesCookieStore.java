 ...
 * @author michael yang
 */
public class XPreferencesCookieStore implements CookieStore {

    private static final String COOKIE_PREFS = "CookiePrefsFile_";
     ...
     */
    public XPreferencesCookieStore(Context context) {
