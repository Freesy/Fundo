...
public class Heartprogressview extends View {
  ...
  /*  private static final int[] SECTION_COLORS = {Color.GREEN, Color.YELLOW,
   ...
   // final int mBarInterval = 7;//TODO 每段间隔
    ...
    private float maxCount = 200;
    private float currentCount = 200;
    ...
    private void init(Context context) {
        ...
        BlurMaskFilter bm=new BlurMaskFilter(2, BlurMaskFilter.Blur.SOLID);
    ...
    protected void onDraw(Canvas canvas) {
      ...
      //  mPaint.reset();
       // Log.e("currentCount", currentCount+"du");
        canvas.drawArc(nrectBlackBg, -90,(float) (currentCount*1.8), false, n2Paint);
        canvas.drawArc(nrectBlackBg, (float) (currentCount*1.8-90),(float) ((maxCount-currentCount)*1.8), false, nPaint);
        canvas.drawArc(nrectBlackBg, (float) (currentCount*1.8-90),(float) 0.1, false, aPaint);
      //  nPaint.reset();
    }
